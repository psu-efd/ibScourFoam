...
void kOmegaIB<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicTurbulenceModel>
kOmegaIB<BasicTurbulenceModel>::kOmegaIB
(
...
template<class BasicTurbulenceModel>
bool kOmegaIB<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaIB<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
