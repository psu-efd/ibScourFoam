...
tmp<volSymmTensorField> WALEIB<BasicTurbulenceModel>::Sd
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WALEIB<BasicTurbulenceModel>::k
(
    const volTensorField& gradU
) const
{
...
template<class BasicTurbulenceModel>
void WALEIB<BasicTurbulenceModel>::correctNut()
{
//    this->nut_ = Ck_*this->delta()*sqrt(this->k(fvc::grad(this->U_)));
    volScalarField KK=this->k(fvc::grad(this->U_));
    this->nut_ = Ck_*this->delta()*sqrt(KK);
    ...
    const immersedBoundaryFvMesh& IBmesh = const_cast<immersedBoundaryFvMesh&>
       ...
       IBmesh.SmagorinskyCorrection(*this,KK);
}
...
template<class BasicTurbulenceModel>
WALEIB<BasicTurbulenceModel>::WALEIB
(
...
template<class BasicTurbulenceModel>
bool WALEIB<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WALEIB<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
void WALEIB<BasicTurbulenceModel>::correct()
{
